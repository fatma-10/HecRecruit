...
import com.IHEC.Recruit.service.EntrepriseService;
...
public class WishlistController {
    ...
    public String ajouter(@PathVariable int candidatId, RedirectAttributes attrs) {
    ...
    public String retirer(@PathVariable int candidatId, RedirectAttributes attrs) {
        Entreprise me = currentUser.getEntreprise();
